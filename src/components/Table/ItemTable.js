...
function createData(id, name, rows, columns, height, weight) {
  return { id, name, rows, columns, height, weight };
}
...
function EnhancedTableHead(props) {
  const { onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, onDelete } =
    props;
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.columns}</TableCell>
